...
anova(Mod1,Mod2)#Same AIC, not signif, 

#Remove Treatment*InitialAshDepth +  (highest P)
Mod3<-glmer.nb(CopyNumberPerGram ~ Treatment*TSF + Treatment*Precip + 
                 Treatment + TSF + Precip + InitialAshDepth +
                 (1|Plot) + (1|TSFdays), nAGQ=0, data = MetaBioBac);summary(Mod3)
anova(Mod2,Mod3)#Same AIC, not signif, remove
...
anova(Mod3,Mod4)#Mod 3 better, Significant, do not remove.........................................

#Treatment*TSF + 
Mod5<-glmer.nb(CopyNumberPerGram ~ Treatment + TSF + Precip + InitialAshDepth +
            Treatment*Precip + (1|Plot) + (1|TSFdays), nAGQ=0, data = MetaBioBac);summary(Mod5)
anova(Mod3,Mod5)#Mod 3 better, signif, do not remove................................................

#Remove single variables by least signficance
#Remove InitialAshDepth + (highest P)
Mod6<-glmer.nb(CopyNumberPerGram ~ Treatment + TSF + Precip + Treatment*Precip + Treatment*TSF +
                 (1|Plot) + (1|TSFdays), nAGQ=0, data = MetaBioBac);summary(Mod6)
anova(Mod3,Mod6)#Mod 6 better, not signif, remove
...
anova(Mod6,Mod7)#Same AIC, not signif, remove
...
Mod9<-glmer.nb(CopyNumberPerGram ~Treatment*Precip + Treatment*TSF +
                 (1|Plot) + (1|TSFdays), nAGQ=0, data = MetaBioBac);summary(Mod9)
...
#3 models same AIC, but model 9 is more parsimpnious
...
#  ............ Final Model -Results  ................................................................................
#******************************************************************************************************************----
FunMod<-glmer.nb(CopyNumberPerGram ~Treatment*Precip + Treatment*TSF +
                   (1|Plot) + (1|TSFdays), nAGQ=0, data = MetaBioBac);summary(FunMod)
R2Full<-r.squaredGLMM(FunMod);R2Full#Delta; R2m = 0.2992549 0.4627244
