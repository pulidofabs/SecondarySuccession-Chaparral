...
#Load data .........................................................................................
Metadata<-read_tsv("Metadata/Fungi/MetaRareSoilPhylo.tsv")#Rare metadata
...
#SUBSET DATA
Burned<-subset_samples(physeq,Treatment=="Burned");Burned#11595x199
sample_names(Burned);sample_data(Burned)$TSFdays

Unburned<-subset_samples(physeq,Treatment=="Unburned");Unburned#11595x103
...
RelGenB1<-read.csv("1-Analysis/RelativeAbundance/TurnOverRates/Data/RelativeAbund-TurnoverSoil-Burned.csv")
library(tidyverse)
Burned<- RelGenB1%>%
  filter(!is.na(Genus)) %>%
...
RateFun<-ggplot(CommRes, aes(interval, distance, color = Treatment)) +
  geom_point(size=3) +
  ...
  labs(x = "Time Interval",y="Distance");RateFun
      
RateFun2<-RateFun+ facet_wrap(~Treatment) +
  theme(strip.text.x = element_text(size = 17),
        strip.background =element_rect(fill="white"));RateFun2




#Export graphs and table to calculate significance......................................................
pdf("1-Analysis/RelativeAbundance/TurnOverRates/Graphs/RateChangeInterval-Fun.pdf", height=8, width=8)
RateFun
dev.off()
