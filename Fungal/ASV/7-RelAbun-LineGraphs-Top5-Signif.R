...
# EXPORT DATA FILES --------------------------------------------------------------------------------------------------------------
dir.create(file.path("1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil"), recursive=TRUE)


#Export soil samples ......................................................................................................
write.csv(RAGen5Trt,"1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-Trt-Top5Genus-Soil.csv")
write.csv(Gen5Burn , "1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-TSF-Top5Genus-Burned-Soil.csv")
write.csv(Gen5Unburn, "1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-TSF-Top5Genus-Unburned-Soil.csv")
...
RAGen5Trt<-read.csv("1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-Trt-Top5Genus-Soil.csv")
Gen5Burn<-read.csv("1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-TSF-Top5Genus-Burned-Soil.csv")
Gen5Unburn<-read.csv("1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Data-TSF-Top5Genus-Unburned-Soil.csv")
...
Top5GenBsoil<-ggplot(Gen5Burn, aes(x=TSF, y=Abundance, group=Genus))+
  ...
  scale_color_manual(values = GenColB)+
  theme_bw()+
...
#EXPORT FILES AS PDF------------------------------------------------------------------------------------------
dir.create(file.path("1-Analysis/RelativeAbundance/Fungi/Graphs/Soil/Lineplots"), recursive=TRUE)


pdf("1-Analysis/RelativeAbundance/Fungi/Graphs/Soil/Lineplots/Top5-Genus-Burned-linearSoil.pdf", height=6.5, width=10)
Top5GenBsoil
dev.off()

pdf("1-Analysis/RelativeAbundance/Fungi/Graphs/Soil/Lineplots/Top5-Genus-Unburned-linearSoil.pdf", height=8, width=12)
Top5GenUsoil
dev.off()
...
#**********************************************************************************************************************----
#Load data---------------------------------------------------------------------------------------------
#Asco<-read.csv("Analysis/RelativeAbundance/Fungi/TSF-Line/Tables/Ascos-Top3-Genus.csv")
...
capture.output(LMPyroSum, file="1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Top5Pyronema-TSF.csv")
capture.output(LMInoSum, file="1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Top5Inocybe-TSF.csv")
capture.output(LMGemiSum, file = "1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Top5Geminibasidium-TSF.csv")
capture.output(LMAsperSum, file="1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Top5Aspergillus-TSF.csv")
capture.output(LMPeniSum, file = "1-Analysis/RelativeAbundance/Fungi/Tables/LineGraph/Soil/Top5Penicillium-TSF.csv")
