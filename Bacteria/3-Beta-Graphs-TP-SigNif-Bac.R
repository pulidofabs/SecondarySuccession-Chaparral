...
#Pairwise adonis using using a distance matrix as an input.................does not allow for interaction
...
capture.output(AdonFull,file="1-Analysis/Diversity/Beta/Tables/Signif/Adonis-FullModel-Bac.csv")
